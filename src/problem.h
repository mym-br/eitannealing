...
public:
	...
	// Getters and setters
	bool getIgnoreouterring() {return ignoreouterring; }
	void setIgnoreouterring(bool _ignoreouterring) {ignoreouterring = _ignoreouterring; }
	...
	problem(const char *meshfilename) : groundNode(-1), nodeCoef(nullptr),
		...
		capacitance(0.0), isCapacitive(false), calibrationMode(0), ignoreouterring(false) {};
	virtual ~problem();
