...
private:
	gradientNormRegularisation(std::shared_ptr<problem<Scalar, Eigen::VectorXd, matrix>> _input);
...
public:
	...
	static void initInstance(std::shared_ptr<problem<Scalar, Eigen::VectorXd, matrix>> _input);
