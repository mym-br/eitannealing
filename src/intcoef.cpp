...
intCoef::intCoef(
      ...
      int numcoefficients):numcoefficients(numcoefficients), x(numcoefficients)
{
    x.fill(0.0);
...
void intCoef::initInstance()
{
    instance = new intCoef(nodes, elements, node2coefficient, ::numcoefficients);
}

intCoef* intCoef::getInstance()
{
    return instance;
}
