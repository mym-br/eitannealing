...
")
  ...
  # Custom Additions to include MPI paths and libraries
  find_package(MPI REQUIRED)

  # Add MPI includes to PETSc includes
  list(APPEND petsc_includes_minimal ${MPI_INCLUDE_PATH})

  # Add MPI libraries to PETSc libraries
  list(APPEND PETSC_LIBRARIES_TS ${MPI_LIBRARIES})
...
# Add MPI includes to PETSc includes
list(APPEND PETSC_INCLUDES ${MPI_INCLUDE_PATH})

# Add MPI libraries to PETSc libraries
list(APPEND PETSC_LIBRARIES ${MPI_LIBRARIES})